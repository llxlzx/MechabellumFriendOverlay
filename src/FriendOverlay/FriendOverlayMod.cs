...
[assembly: MelonInfo(typeof(FriendOverlay.FriendOverlayMod), "FriendOverlay", "0.3.38", "MechabellumFriendOverlay")]
...
namespace FriendOverlay
{
    public sealed class FriendOverlayMod : MelonMod
    {
        ...
        private void LoadPreferences()
        {
            ...
            _prefUseGameFont = _prefs.CreateEntry("UseGameFont", false, "Prefer in-game friend-row font before Noto/YaHei (default uses Noto Sans SC Medium)");
